                                        ...
                                        <div className="space-y-2">
                                            {[
                                                ...
                                                <div key={i} className={`flex items-center justify-between p-3 bg-[#F8F9FA] dark:bg-[#111318] border border-[#DEE2E6] dark:border-[#3A3D44] rounded-sm hover:border-[#3366CC] transition-all`}>
                                                    <div className="flex items-center gap-3">
                                                        <div className={`w-9 h-9 rounded-sm ${emp.color} text-white flex items-center justify-center font-black text-xs shadow-sm`}>{React.cloneElement(emp.icon as React.ReactElement<any>, { size: 16 })}</div>
                                                        <div>
