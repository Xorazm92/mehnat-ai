...
export function AdminModulePlaceholder({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-24 px-6">
      ...
      <div
        className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full text-meta font-bold uppercase tracking-widest"
        style={{
      ...
      {mod?.featureFlag && (
        <p className="mt-4 text-meta" style={{ color: "var(--text-muted)" }}>
