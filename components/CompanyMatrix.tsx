            ...
            {filteredData.map(c => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-center">
                    <StatusBadge status={(c.taxType === TaxType.TURNOVER ? ReportStatus.NOT_REQUIRED : op.profitTaxStatus) as string} size="sm" />
                  </td>
                  <td className="px-4 py-4 text-center">
                    <StatusBadge status={op.form1Status as string} size="sm" />
                  </td>
                  <td className="px-4 py-4 text-center">
                    <StatusBadge status={op.form2Status as string} size="sm" />
                  </td>
                  <td className="px-4 py-4 text-center">
                    <div className="flex flex-col items-center gap-1">
                      <StatusBadge status={op.statsStatus as string} size="sm" />
