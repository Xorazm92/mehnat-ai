...
export const ALLOWED_VIEWS: Record<UserRole, AppView[]> = {
    [ROLES.SUPER_ADMIN]: ['dashboard', 'organizations', 'staff', 'reports', 'kpi', 'kassa', 'expenses', 'cabinet', 'payroll', 'audit_logs'],
    [ROLES.ADMIN]: ['dashboard', 'organizations', 'staff', 'reports', 'kpi', 'kassa', 'expenses', 'cabinet', 'payroll', 'audit_logs'],
    [ROLES.CHIEF_ACCOUNTANT]: ['dashboard', 'organizations', 'staff', 'reports', 'kpi', 'kassa', 'expenses', 'cabinet', 'payroll'],
    [ROLES.SUPERVISOR]: ['dashboard', 'organizations', 'staff', 'reports', 'kpi', 'kassa', 'expenses', 'cabinet', 'payroll'],
