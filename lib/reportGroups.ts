...
export const COLUMN_CATEGORY: Record<OperationFieldKey, ReportCategory> = {
  ...
  dividend_soligi: "SOLIQ",
  dividend_soligi_tolov: "SOLIQ",
  aksiz_soligi_tolov: "SOLIQ",
  nedro_soligi_tolov: "SOLIQ",
  norezident_foyda_tolov: "SOLIQ",
  norezident_nds_tolov: "SOLIQ",
  mol_mulk_soligi_tolov: "SOLIQ",
  yer_soligi_tolov: "SOLIQ",
  suv_soligi_tolov: "SOLIQ",
  jismoniy_ijara_tolov: "SOLIQ",
  bonak_tolov: "SOLIQ",
  foyda_avans_hisobot: "SOLIQ",
  mol_mulk_yillik: "SOLIQ",
  yer_yillik: "SOLIQ",
  suv_yillik: "SOLIQ",
  ...
  stat_1_hisobot_mazmuni: "STATISTIKA",
  stat_4_qx: "STATISTIKA",
