  ...
  return (
    <div className="h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white tracking-tight">Hujjatlar</h1>
      ...
      <div className="glass-card p-8 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-bold text-white mb-2">Hujjatlar Boshqaruvi</h3>
        <p className="text-text-secondary max-w-md mx-auto">
          Kompaniya va xodimlarga tegishli barcha hujjatlar, shartnomalar va ishonchnomalar saqlanadigan baza.
        </p>
      </div>
    </div>
  );
