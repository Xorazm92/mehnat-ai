  ...
  return (
    <div className="h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white tracking-tight">Davomat</h1>
      ...
      <div className="glass-card p-8 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-bold text-white mb-2">Davomat Moduli</h3>
        <p className="text-text-secondary max-w-md mx-auto">
          Bu yerda xodimlarning davomat (kirib-chiqish) vaqtlari va smenalari boshqariladi.
        </p>
      </div>
    </div>
  );
