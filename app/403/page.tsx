  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href="/dashboard"
          className="inline-flex px-6 py-3 rounded-xl text-white text-[11px] font-bold uppercase tracking-widest transition-all shadow-md hover:shadow-lg active:scale-95"
